...
import { FaGithub, FaLinkedin, FaTwitter, FaEnvelope, FaFacebook, FaYoutube, FaHeart, FaArrowUp } from 'react-icons/fa';
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          <div className="text-gray-400 text-sm mb-4 md:mb-0">
            © 2025 Made with <FaHeart className="inline text-red-500 mx-1" /> by Md Moniruzzaman Tonoy
          </div>
